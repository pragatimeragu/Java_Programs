...
//// what if there is no such method show in parent (B class ) and present in child class 
...
// Output of code - Error 
//becoz  method is not in parent 
